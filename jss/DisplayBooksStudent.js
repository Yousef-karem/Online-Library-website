    ...
    myBooks.forEach((books, category) => {
        ...
        books.forEach(book => {
            ...
            innerfram.innerHTML = `
                ...
                <div class="bottom">
                <button ${book.isBorrowed ? 'disabled' : ''} class="borrowButton">
            ...
            let BorrowButton = innerfram.querySelector('.borrowButton');
            BorrowButton.addEventListener('click', () => {
                ...
                updateLocalStorage();
                alert("Added to your Borrowed List");
                window.location.href="Books.html";
            });
            let favButton = innerfram.querySelector('.favbutton');
